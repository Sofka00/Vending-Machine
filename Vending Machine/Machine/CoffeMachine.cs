...
{
    public class CoffeMachine : AbstractMachine
    {
        public CoffeMachine(int id, decimal balance, Dictionary<string, int> product, string adress) : base(id, balance, adress)
        {
